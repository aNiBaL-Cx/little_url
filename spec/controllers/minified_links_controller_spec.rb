...
RSpec.describe MinifiedLinksController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      minified_link = MinifiedLink.create! valid_attributes
      get :show, params: {id: minified_link.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created minified_link" do
        post :create, params: {minified_link: valid_attributes}, session: valid_session
        expect(response).to redirect_to(MinifiedLink.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {minified_link: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
